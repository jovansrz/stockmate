      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 relative bg-white overflow-y-auto">
        ...
        >
          <div className="text-center lg:text-left mb-10">
            ...
            <h2 className="text-3xl font-bold text-slate-900 mb-2">{t('auth.createAccount')}</h2>
            <p className="text-slate-500">{t('auth.joinNow')}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.div variants={itemVariants} initial="hidden" animate="show" custom={3}>
              <label className="block text-sm font-semibold text-slate-700 mb-1.5">
                {t('auth.password')}
              </label>
              <input
